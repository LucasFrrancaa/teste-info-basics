...
const QB = [
  ...
  { c: "Informática Básica", q: "Você precisa selecionar todo o conteúdo de um documento de uma só vez para alterar a fonte globalmente. Qual atalho utiliza?", o: ["Ctrl + T", "Ctrl + A", "Ctrl + S", "Ctrl + E"], a: 1 },
  ...
  { c: "Informática Básica", q: "Você selecionou o título de um relatório e quer aplicar negrito rapidamente, sem tirar as mãos do teclado. Qual atalho utiliza?", o: ["Ctrl + I", "Ctrl + N", "Ctrl + B", "Ctrl + T"], a: 2 },
  ...
  { c: "Informática Básica", q: "Para destacar uma cláusula importante de um contrato com sublinhado, você seleciona o texto e utiliza qual atalho?", o: ["Ctrl + B", "Ctrl + I", "Ctrl + U", "Ctrl + S"], a: 2 },
